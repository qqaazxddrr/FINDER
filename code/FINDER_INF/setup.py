...
setup(
    ...
    ext_modules = [
                    ...
                    Extension('inf_env', sources=['inf_env.pyx', 'src/lib/inf_env.cpp', 'src/lib/igraph.cpp','src/lib/disjoint_set.cpp'], language='c++',extra_compile_args=['-std=c++11', '-stdlib=libc++']),                                                                  # *
                    ...
                    Extension('nstep_replay_mem', sources=['nstep_replay_mem.pyx', 'src/lib/nstep_replay_mem.cpp', 'src/lib/igraph.cpp', 'src/lib/inf_env.cpp'], language='c++',extra_compile_args=['-std=c++11', '-stdlib=libc++']),               # check
